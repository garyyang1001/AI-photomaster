...
def test_presentation_download(page: Page):
    ...
    # 3. Act: Send a message to generate text and an image
    ...
    # 4. Act: Click the download presentation button
    download_button = page.get_by_role("button", name="下載簡報")
